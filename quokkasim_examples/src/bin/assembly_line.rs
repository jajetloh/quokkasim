...
fn create_bench() {
    ...
    let mut source: DefaultDiscSource<String, DiscProcessLog<String>> = DefaultDiscSource::new()
        .with_name("Source")
        .with_code("SRC")
    ...
    let mut process: DefaultDiscProcess<String, DiscProcessLog<String>> = DefaultDiscProcess::new()
        .with_name("Process")
        .with_code("P")
    ...
    let mut sink : DefaultDiscSink<String, DiscProcessLog<String>> = DefaultDiscSink::new()
        .with_name("Sink")
        .with_code("SNK")
    ...
    let process_logger = EventQueue::<DiscProcessLog<String>>::new();
    ...
    let (mut sim, _sched) = sim_init.init(start_time).unwrap();
